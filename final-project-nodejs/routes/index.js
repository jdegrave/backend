...
module.exports = function (passport) {
	...
	router.post('/login', passport.authenticate('local-login', {
		successRedirect : '/drivers', // redirect to the secure drivers tab
    ...
    router.post('/signup', passport.authenticate('local-signup', {
        successRedirect : '/login', // redirect to the secure drivers tab
		failureRedirect : '/signup', // redirect back to the signup page if there is an error
		failureFlash : true // allow flash messages });
    }));

    router.get('/drivers', isLoggedIn, function (req, res) {
    ...
    router.post('/drivers/update1', isLoggedIn, function (req, res) {
    ...
    router.get('/trips', isLoggedIn, function (req, res) {
    ...
    router.post('/trips', function (req, res) {
        ...
        return tripServices.createTrip(newTrip)
            .then(function (currentTrip) {
                ...
                trip = currentTrip;
                return tripServices.populateDrivers(currentTrip.availableDrivers)
                    .then(function (allDriversAvailable) {
                        tripDrivers = allDriversAvailable;
                        tripServices.startTripMonitor(currentTrip, allDriversAvailable);
    ...
    router.get('/trips/:id', isLoggedIn, function (req, res) {
